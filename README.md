# Description
This is a C# 🟪 console application to integrate the console with MSAL .net (Microsoft Authentication Library) 🔐. This is in order to study and practice for az204 certification exam 🤓📚🎓
